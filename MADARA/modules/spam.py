...
from MADARA.data import GROUP, PORMS
    ...
    if event.sender_id in SUDO_USERS:
        if event.chat_id in GROUP:
            ...
            try:
                ...
                await event.reply(f"🔞 **Usage:**  {hl}pspam 13", buttons=[[Button.inline("Help", data="help_back")]])
            except Exception as e:
                print(e)
    ...
    if e.sender_id in SUDO_USERS:
        if e.chat_id in GROUP:
            ...
            try:
                ...
                await event.reply(f"😈 **Usage:** {hl}hang 10", buttons=[[Button.inline("Help", data="help_back")]])
            except Exception as e:
                print(e)
